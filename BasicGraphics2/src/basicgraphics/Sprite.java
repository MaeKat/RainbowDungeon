...
public class Sprite {
    ...
    private int drawingPriority, health;
    ...
    double previousY, previousX;
    
    public void prevY(double prevY){ this.previousY = prevY;}
    public void prevX(double prevX){ this.previousX = prevX;}
    public double getPrevX(){return previousX;}
    public double getPrevY(){return previousY; }
